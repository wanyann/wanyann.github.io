...
3) Когда форк сделан, переходим на страницу https://nickcoutsos.github.io/keymap-editor/, на открывшейся странице выбираем GitHub, авторизуемся и предоставляем доступ к созданному форку для keymap-editor.
...
В сплит-клавиатурах используются слои, это своего рода дополнительные модификаторы, как Shift или Control, и переключив клавиатуру на другой слой, нажатия клавиш будут регистрировать уже другие символы или функции, назначенные на эту клавишу на этом слое. Звучит сложно, надо рассмотреть на примере:
Если нажать и не отпускать красную клавишу на левой половинке, то клавиатура переключится на 1 слой, и нажав, например, клавишу в позиции "W", в ОС отправится нажатие клавиши "2", т.к. в раскладке по умолчанию она назначена на позицию "W" на 1 слое.
