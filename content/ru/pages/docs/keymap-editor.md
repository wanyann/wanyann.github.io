...
1) Находясь на 0-м слое нажат `&tog 2` - слой 2 включен, переключиться на 1 слой нажатием `&tog 1` или `&mo 1` не получится;
2) Находясь на 2-м слое нажат `&tog 2` - слой 2 выключен, клавиатура вернулась на 0-й слой, и мы можем переключаться на 1-й слой.
