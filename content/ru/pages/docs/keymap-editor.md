...
Для предоставлении доступа отмечаем опцию *Only select repositories*, и выбраем Ваш форк репозитория `/ergohaven/ergohaven-zmk-config`. Далее нажимаем **Save** для сохранения настроек доступа.
