...
- Нажатие **правой клавиши** переключит на следующий профиль подключения (всего доступно 6 профилей, счет ведется начиная с 0);  
...
![image](/images/tb-mini-v3/scroll-td.png)
