...
Для удобства модификации раскладки в прошивке `ruen` добавлены кейкоды алиасы, такие как `RU_COMMA` или `RU_CYRILLIC_TSE`, отображающие на раскладке символы русской раскладки, при этом при нажатии `RU_COMMA` в ОС передастся скан-коды `SC_SLASH` так как в стандартной раскладке ЙЦУКЕН точка находится на клавише слэш. 
...
Вызов макроса назначим на комбо клавиш "J" + "L", такое расположение будет не сложно запомнить, ведь фигурные скобки на символьном слое находятся на этих же местах. 
...
## Ускорение обработки макроса &en
