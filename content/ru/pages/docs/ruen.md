...
Переключает раскладку при коротком нажатии (работает как RuEn Toggle) или же временно переключает раскладку при удержании и возвращает раскладку обратно при отпускании. Таким образом, удерживая эту клавишу, можно вводить символы и последовательности из другой раскладки.
